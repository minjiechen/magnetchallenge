...
Criteria for code review: We hope the teams can convince us the developed method can "automatically" or "semi-automatically" produce an accurate and compact model for a new material without too much human interaction, so that we can quickly/automatically reproduce models for any new material.
