...
if __name__ == '__main__':
    p = core_loss(b_path="2023 MagNet Challenge Testing Data (Public)\\Testing\\Material B\\B_Field.csv",
                  t_path="2023 MagNet Challenge Testing Data (Public)\\Testing\\Material B\\Temperature.csv",
                  f_path="2023 MagNet Challenge Testing Data (Public)\\Testing\\Material B\\Frequency.csv")
