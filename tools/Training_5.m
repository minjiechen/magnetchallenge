...
fprintf(fopen([pwd, '\_Training data\', mat_name, '_Scalar2Scalar.json'], 'w'), JSON); fclose('all');
...
fprintf(fopen([pwd, '\_Training data\', mat_name, '_Seq2Seq.json'], 'w'), JSON); fclose('all');
