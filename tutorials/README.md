...
Attached is the larger sequence to scalar dataset, [Dataset_full.json](https://drive.google.com/file/d/1F9NeccZN5GYBtsMlI-Xk8GZTYLcIcxL_/view), for the core-loss LSTM demo.
