...
Here is the larger [sequence to scaler dataset](https://drive.google.com/file/d/1F9NeccZN5GYBtsMlI-Xk8GZTYLcIcxL_/view), Dataset_full.json, for the core-loss LSTM demo.
